    ...
    <div className='relative min-h-screen bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900 text-white overflow-hidden'>
      ...
      <section className='relative z-10 min-h-screen flex flex-col items-center justify-center text-center space-y-8 max-w-4xl mx-auto px-4'>
        ...
        <div className='space-y-4'>
          <h1 className='text-5xl md:text-7xl h-20 font-extrabold tracking-tight leading-tight bg-clip-text text-transparent bg-gradient-to-r from-purple-300 via-pink-300 to-yellow-300 animate-fade-in'>
            FuelForm is
          </h1>
          <h1 className='text-5xl md:text-7xl h-20 font-extrabold tracking-tight leading-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-300 via-purple-300 to-pink-300 animate-fade-in delay-100'>
            Coming Soon!
          </h1>
