...
-- Supabase Auth handles passwords, so we don't need password_hash in our users table

-- First, drop the existing users table and recreate it without password_hash
DROP TABLE IF EXISTS users CASCADE;

-- Recreate users table without password_hash (Supabase Auth handles this)
CREATE TABLE users (
    id UUID PRIMARY KEY, -- This will match the Supabase Auth user ID
...
-- Recreate all the dependent tables (they were dropped with CASCADE)
