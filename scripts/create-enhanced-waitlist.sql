-- Enhanced waitlist table with referral system
...
INSERT INTO waitlist (email, user_type, referral_source, ab_test_variant) VALUES
('john.fitness@example.com', 'client', 'social_media', 'A'),
('sarah.trainer@example.com', 'trainer', 'word_of_mouth', 'B'),
('mike.gym@example.com', 'client', 'google_search', 'A'),
('lisa.coach@example.com', 'trainer', 'referral', 'B')
...
UPDATE waitlist SET referral_count = 1 WHERE email = 'john.fitness@example.com';
